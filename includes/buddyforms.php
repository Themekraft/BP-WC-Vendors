...
function bp_wcv_buddyforms_members_admin_settings_sidebar_metabox() {
	add_meta_box( 'bp_wcv_buddyforms_buddyforms', __( "BP Member Profiles", 'buddyforms' ), 'bp_wcv_buddyforms_members_admin_settings_sidebar_metabox_html', 'buddyforms', 'normal', 'low' );
...
function bp_wcv_buddyforms_members_admin_settings_sidebar_metabox_html() {
	...
	$form_setup[] = new Element_Checkbox( "<b>" . __( 'Add this form as Vendor Dashboard Tab', 'buddyforms' ) . "</b>", "buddyforms_options[wc_vendor_integration]", array( "integrate" => "Integrate this Form" ), array( 'value' => $wc_vendor_integration, 'shortDesc' => __( 'Add this form to the Vendors Dashboard', 'buddyforms' )
	) );
