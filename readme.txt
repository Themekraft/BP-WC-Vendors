...
With BP WC Vendors you are able to build a highly customizable BuddyPress driven marketplace. All WC Vendor dashboard tabs get integrated into the BuddyPress Member Profiles.

We have build many BuddyPress driven shops and marketplaces and put all our experience and knowledge into this solution.
We believe with the right combination of plugins BuddyPress is the best choice to build a powerful marketplaces.
Our focus is to have an extendable and flexible environment ready to build up the marketplace you need.
<br><br>

<h3>BuddyPress and WooCommerce -> The Marketplace Power House </h3>
...
We have bundled the best plugins together and support all of them 100% with this plugin.
We give you all the expriences we got from building countless BuddyPress driven shops and marketplaces.
<br><br>
...
<p>You need a couple of plugins installed for the BP WC Vendors Social Marketplace come to live. Please make sure you have the following plugins installed and activated.</p>
<ul>
...
This plugins are not needed but make a lot of sense in many cases.
<ul>
  <li><b>WC4BP - WooCommerce BuddyPress Integration</b>
    ...
    Find out more on the <a href="https://wc4bp.com">wc4bp.com</a> site
    </p>
  </li>
  ...
  <li><b>BuddyForms</b>
    ...
    <p>Use BuddyForms to create easy using product creation forms and benefit from many extensions like moderation, post meta and custom fields.</p>
    <p>BuddyForms is a full front-end content submission CMS and can be use to build any kind of product forms. Find out more on the <a href="https://buddyforms.com">buddyforms.com</a></p>
    </li>
</ul>
<br><br>

<h4>Frontend Product Management</h4>
<p>For the product management we recommend BuddyForms and some extensions depend on your needs.</p>
<ul>
  ...
  <li><i>Check out all the other BuddyForms extensions like WooCommerce Simple Auction. <a href="https://buddyforms.com/extensions-for-wordpress-forms/">Search Extensions</a></i></li>
</ul>
<br>


We hope you enjoy the plugin. Please let us know if we missed a plugin that works well with BuddyPress and WooComerce and give a Social Marketplace a great benefit.
We will give it a deep review and support it if it makes sense.
...
<h4>Does it work with WC Vendors Free?</h4>
...
<h4>Do I need BuddyForms and WC4BP?</h4>
